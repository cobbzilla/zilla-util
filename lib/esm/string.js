...
export const dateAsYYYYMMDD = (date) => `${date.getFullYear()}-${(date.getMonth() + 1).toString().padStart(2, "0")}-${date
    ...
    .toString()
    .padStart(2, "0")}`;
export const dateAsYYYYMMDD_HHmmSS = (date) => `${date.getFullYear()}${(date.getMonth() + 1).toString().padStart(2, "0")}${date
    .getDate()
    .toString()
...
export const timestampAsYYYYMMDD_HHmmSS = (timestamp) => dateAsYYYYMMDD_HHmmSS(new Date(timestamp));
