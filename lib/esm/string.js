...
export const date_as_yyyyMMdd = (date) => `${date.getFullYear()}-${(date.getMonth() + 1).toString().padStart(2, "0")}-${date
    ...
    .toString()
    .padStart(2, "0")}`;
export const date_as_yyyyMMddHHmmSS = (date) => `${date.getFullYear()}-${(date.getMonth() + 1).toString().padStart(2, "0")}-${date
    .getDate()
    .toString()
...
export const timestamp_as_yyyyMMddHHmmSS = (timestamp) => date_as_yyyyMMddHHmmSS(new Date(timestamp));
