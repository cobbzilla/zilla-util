...
export const safeStringify = (obj, logger) => {
...
export const countVisibleChars = (data) => splitter.countGraphemes(typeof data === "string" ? data : new TextDecoder("utf-8").decode(data));
